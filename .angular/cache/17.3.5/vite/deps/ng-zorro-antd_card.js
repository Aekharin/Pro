...
function NzCardLoadingComponent_For_2_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const className_r1 = ctx.$implicit;
    ɵɵproperty("ngClass", className_r1);
  }
}
function NzCardLoadingComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 1);
    ɵɵrepeaterCreate(1, NzCardLoadingComponent_For_2_For_2_Template, 2, 1, "div", 2, ɵɵrepeaterTrackByIdentity);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const listOfClassName_r2 = ctx.$implicit;
    ɵɵadvance();
    ɵɵrepeater(listOfClassName_r2);
  }
}
var _c0 = ["*"];
...
function NzCardComponent_Conditional_0_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzCardComponent_Conditional_0_Conditional_2_ng_container_1_Template, 2, 1, "ng-container", 8);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function NzCardComponent_Conditional_0_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzCardComponent_Conditional_0_Conditional_3_ng_container_1_Template, 2, 1, "ng-container", 8);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
...
function NzCardComponent_Conditional_0_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NzCardComponent_Conditional_0_Conditional_4_ng_template_0_Template, 0, 0, "ng-template", 7);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
...
function NzCardComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, NzCardComponent_Conditional_0_Conditional_2_Template, 2, 1, "div", 5)(3, NzCardComponent_Conditional_0_Conditional_3_Template, 2, 1, "div", 6);
    ɵɵelementEnd();
    ɵɵtemplate(4, NzCardComponent_Conditional_0_Conditional_4_Template, 1, 1, null, 7);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function NzCardComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 1);
    ɵɵtemplate(1, NzCardComponent_Conditional_1_ng_template_1_Template, 0, 0, "ng-template", 7);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
function NzCardComponent_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, NzCardComponent_Conditional_5_For_2_ng_template_2_Template, 0, 0, "ng-template", 7);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
...
function NzCardComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵrepeaterCreate(1, NzCardComponent_Conditional_5_For_2_Template, 3, 3, "li", 9, ɵɵrepeaterTrackByIndex);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
_NzCardLoadingComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 3,
  vars: 0,
  consts: [[1, "ant-card-loading-content"], [1, "ant-row", 2, "margin-left", "-4px", "margin-right", "-4px"], [2, "padding-left", "4px", "padding-right", "4px", 3, "ngClass"], [1, "ant-card-loading-block"]],
  template: function NzCardLoadingComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelementStart(0, "div", 0);
      ɵɵrepeaterCreate(1, NzCardLoadingComponent_For_2_Template, 3, 0, "div", 1, ɵɵrepeaterTrackByIdentity);
      ɵɵelementEnd();
    }
    if (rf & 2) {
      ɵɵadvance();
...
_NzCardComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 6,
  vars: 5,
  consts: [[1, "ant-card-head"], [1, "ant-card-cover"], [1, "ant-card-body", 3, "ngStyle"], [1, "ant-card-actions"], [1, "ant-card-head-wrapper"], [1, "ant-card-head-title"], [1, "ant-card-extra"], [3, "ngTemplateOutlet"], [4, "nzStringTemplateOutlet"], [3, "width"]],
