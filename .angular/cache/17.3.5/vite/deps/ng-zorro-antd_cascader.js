import {
  NzHighlightModule,
  NzHighlightPipe
} from "./chunk-Z6RLJAK2.js";
import {
  NzEmbedEmptyComponent,
  NzEmptyModule
} from "./chunk-TJJU5RWD.js";
import {
  NzI18nService
...
function NzCascaderOptionComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzCascaderOptionComponent_Conditional_2_Conditional_1_Template, 1, 0, "span", 3)(2, NzCascaderOptionComponent_Conditional_2_Conditional_2_Template, 1, 1);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵconditional(1, ctx_r0.option.loading ? 1 : 2);
  }
}
...
function NzCascaderComponent_Conditional_3_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵconditional(1, !ctx_r2.isLabelRenderTemplate ? 1 : 2);
  }
}
function NzCascaderComponent_Conditional_3_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵstyleProp("visibility", !ctx_r2.inputValue ? "visible" : "hidden");
    ɵɵadvance();
...
function NzCascaderComponent_Conditional_3_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵconditional(1, !ctx_r2.isLoading ? 1 : 2);
    ɵɵadvance(2);
    ɵɵconditional(3, ctx_r2.hasFeedback && !!ctx_r2.status ? 3 : -1);
  }
}
function NzCascaderComponent_Conditional_3_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "span", 11)(1, "span", 19);
...
function NzCascaderComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵelementEnd()();
    ɵɵtemplate(5, NzCascaderComponent_Conditional_3_Conditional_5_Template, 3, 2, "span", 9)(6, NzCascaderComponent_Conditional_3_Conditional_6_Template, 2, 3);
    ɵɵelementEnd();
    ɵɵtemplate(7, NzCascaderComponent_Conditional_3_Conditional_7_Template, 4, 4, "span", 10)(8, NzCascaderComponent_Conditional_3_Conditional_8_Template, 2, 0, "span", 11);
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ɵɵadvance(3);
...
function NzCascaderComponent_ng_template_5_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "ul", 23)(1, "li", 24);
    ɵɵelement(2, "nz-embed-empty", 25);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
...
function NzCascaderComponent_ng_template_5_Conditional_4_For_1_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const i_r8 = ɵɵnextContext().$index;
    const ctx_r2 = ɵɵnextContext(3);
    ɵɵproperty("expandIcon", ctx_r2.nzExpandIcon)("columnIndex", i_r8)("nzLabelProperty", ctx_r2.nzLabelProperty)("optionTemplate", ctx_r2.nzOptionRender)("activated", ctx_r2.isOptionActivated(option_r7, i_r8))("highlightText", ctx_r2.inSearchingMode ? ctx_r2.inputValue : "")("option", option_r7)("dir", ctx_r2.dir);
  }
}
function NzCascaderComponent_ng_template_5_Conditional_4_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "ul", 27);
    ɵɵrepeaterCreate(1, NzCascaderComponent_ng_template_5_Conditional_4_For_1_For_2_Template, 1, 8, "li", 28, _forTrack0);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function NzCascaderComponent_ng_template_5_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵrepeaterCreate(0, NzCascaderComponent_ng_template_5_Conditional_4_For_1_Template, 3, 5, "ul", 26, ɵɵrepeaterTrackByIdentity);
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
...
function NzCascaderComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵelementStart(1, "div", 21, 3);
    ɵɵtemplate(3, NzCascaderComponent_ng_template_5_Conditional_3_Template, 3, 6, "ul", 22)(4, NzCascaderComponent_ng_template_5_Conditional_4_Template, 2, 0);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ...
    ɵɵadvance(2);
    ɵɵconditional(3, ctx_r2.shouldShowEmpty ? 3 : 4);
  }
}
...
_NzCascaderOptionComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 3,
  vars: 2,
  consts: [[3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "ant-cascader-menu-item-expand-icon"], [1, "ant-cascader-menu-item-content", 3, "innerHTML"], ["nz-icon", "", "nzType", "loading"], [4, "nzStringTemplateOutlet"], ["nz-icon", "", 3, "nzType"]],
