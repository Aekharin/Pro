...
function NzProgressComponent_ng_template_0_span_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzProgressComponent_ng_template_0_span_0_ng_container_1_Template, 2, 1, "ng-container", 7)(2, NzProgressComponent_ng_template_0_span_0_ng_template_2_Template, 1, 4, "ng-template", null, 1, ɵɵtemplateRefExtractor);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const formatTemplate_r3 = ɵɵreference(3);
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵadvance();
    ɵɵproperty("ngIf", (ctx_r0.status === "exception" || ctx_r0.status === "success") && !ctx_r0.nzFormat)("ngIfElse", formatTemplate_r3);
  }
}
function NzProgressComponent_ng_template_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NzProgressComponent_ng_template_0_span_0_Template, 4, 2, "span", 5);
  }
  if (rf & 2) {
...
function NzProgressComponent_div_3_ng_container_1_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.nzSuccessPercent || ctx_r0.nzSuccessPercent === 0);
  }
}
...
function NzProgressComponent_div_3_ng_container_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r0.isSteps);
    ɵɵadvance();
...
function NzProgressComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzProgressComponent_div_3_ng_container_1_Template, 3, 2, "ng-container", 3)(2, NzProgressComponent_div_3_div_2_Template, 3, 2, "div", 10);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
function NzProgressComponent_div_4__svg_defs_2__svg_stop_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("offset", i_r6.offset)("stop-color", i_r6.color);
  }
}
function NzProgressComponent_div_4__svg_defs_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngForOf", ctx_r0.circleGradient);
  }
}
function NzProgressComponent_div_4__svg_path_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngStyle", p_r7.strokePathStyle);
    ɵɵattribute("d", ctx_r0.pathString)("stroke-linecap", ctx_r0.nzStrokeLinecap)("stroke", p_r7.stroke)("stroke-width", ctx_r0.nzPercent ? ctx_r0.strokeWidth : 0);
  }
}
...
function NzProgressComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, NzProgressComponent_div_4__svg_defs_2_Template, 3, 2, "defs", 3);
    ɵɵelement(3, "path", 22);
  ...
  if (rf & 2) {
    ...
    ɵɵadvance(2);
    ɵɵproperty("ngIf", ctx_r0.isGradient);
    ɵɵadvance();
    ɵɵproperty("ngStyle", ctx_r0.trailPathStyle);
    ɵɵattribute("stroke-width", ctx_r0.strokeWidth)("d", ctx_r0.pathString);
    ɵɵadvance();
    ɵɵproperty("ngForOf", ctx_r0.progressCirclePath)("ngForTrackBy", ctx_r0.trackByFn);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", progressInfoTemplate_r4);
  }
}
...
_NzProgressComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function NzProgressComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(3, NzProgressComponent_div_3_Template, 3, 2, "div", 3)(4, NzProgressComponent_div_4_Template, 6, 15, "div", 4);
      ɵɵelementEnd();
    }
    if (rf & 2) {
      ɵɵadvance(2);
...
//# sourceMappingURL=chunk-3DD3DJJQ.js.map
